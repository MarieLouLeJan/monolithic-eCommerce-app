...
profilRouter.get('/dashboard/profil/orders', authObligatory, CW(profilController.ordersHistory));
profilRouter.get('/dashboard/profil/orders/details/:orderId', authObligatory, CW(profilController.orderHistoryDetails));
...
profilRouter.get('/dashboard/profil/unactiveAdress/:adressId', CW(profilController.unactiveAdressAction));
